...
public class Basin extends Appliance {
    ...
    public Basin(String type, String path, float x, float y, float energyConsumption, float activationRange,
        ...
        offTexture = new Texture("14.png");
        onTexture = new Texture("15.png");
